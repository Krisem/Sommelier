...
| Komplett katalog + klokker | 2026-08-29/30 | `tools/polet_details.py`, `polet_store.py` | [ADR-024](docs/ARCHITECTURE.md#adr-024-komplett-rødvins-snapshot--målt-api-sannhet-prunet-shape-klokker-via-fasett-sveip) | 27 402 varer (rødvin 13 775 · hvitvin 9 762 · musserende 3 081 · rosé 782). Fem stille bugs funnet underveis, bl.a. servertak på `pageSize`. |
| Klokke-similarity degradert | 2026-08-30 | `tools/vinmonopolet.py` | [ADR-025](docs/ARCHITECTURE.md#adr-025-klokke-similarity-degradert-til-grovfilter--målt-null-diskriminering) | **Negativt resultat, bevisst beholdt:** klokkene korrelerer ~0 med brukerens ratinger (+0,16/+0,09/−0,10). Grovfilter for stil, aldri kvalitet. |
...
>
> **Merk om v1-triggeren:** seksjonene over ble skrevet da `v0_tier` målte +0,59. Tallet er siden målt to ganger til, og det siste — **+0,20** (2026-08-31, revisjon `b8490bb`) — er det første som gjelder modellen slik den faktisk kjører; de to foregående målte en modell som knapt fyrte på Vivino-inngangen. Triggeren er fortsatt ikke oppfylt, men begrunnelsen er snudd: det er ikke lenger «v0 er sterk», det er «v0 er svakere enn antatt, og `vivino_avg` (+0,61) leder fortsatt klart». Se amendmentet i [ADR-017](docs/ARCHITECTURE.md#adr-017-eval-harness-før-v1--modell-agnostisk-rangerings-måling) og [`tasks/maaling_2026-08-31.md`](tasks/maaling_2026-08-31.md).
