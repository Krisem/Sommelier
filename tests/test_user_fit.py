...
# ---------------------------------------------------------------------------
# J — Prosaen i smaksprofil.md mot de auto-deriverte tallene (teknisk gjeld #10)
#
...
#
# Testen ligger her fordi den bevokter nøyaktig den fila `load_profile_rules()`
# parser. Fri prosa («41 av 122 ratede viner er italienske») holdes bevisst
# utenfor — der tipper det over i regex-arkeologi.
#
